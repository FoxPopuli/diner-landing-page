...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n    --link-visited: #ca9c5e;\n    --default-font: Arial, sans-serif;\n    --icon-radius: 10px;\n    --large-icon-size: 40px;\n    --medium-icon-size: 30px;\n    --small-icon-size: 20px;\n}\n\n* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\n\n\n\n/* Element Styles */\nbody {\n    background-color: #000;\n}\n\nheader {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n    width: 100vw;\n    flex-wrap: wrap;\n}\n\n\n\nheader a, .side-nav a {\n    font-family: var(--default-font);\n    text-decoration: none;\n    color: white;\n    display: flex;\n    padding: 5px;\n    justify-content: center;\n\n}\n\na:hover, a:active {\n    color: var(--link-visited);\n}\n\nheader img {\n    width: var(--large-icon-size);\n    margin: 10px;\n}\n\n.social-links {\n    display: flex;\n}\n\nbody {\n    background-color: red;\n}\n\nheader ul {\n    display: none;\n    list-style: none;\n}\n\nheader button {\n    display: block;\n}\n\nli {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n.side-nav {\n    display: flex;\n    flex-direction: column;\n    width: 100vw;\n    background-color: #000;\n    align-items: center\n}\n\na {\n    text-align: center;\n}\n/* Tablet Styles */\n@media only screen and (min-width: 563px) and (max-width: 960px) {\n    body {\n        background-color: orange;\n    }\n\n    header .menu-button {\n        display: none;\n    }\n\n    header img {\n        width: var(--medium-icon-size);\n    }\n\n    header ul {\n        display: flex;\n    }\n\n}\n\n/* Desktop Styles */\n@media only screen and (min-width: 961px) {\n    body {\n        background-color: blue;\n    }\n\n    header .menu-button {\n        display: none;\n    }\n\n    header img {\n        width: var(--small-icon-size);\n    }\n\n    header ul {\n        display: flex;\n    }\n}\n\n/* Toggles */\n.invis {\n    display: none\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,uBAAuB;IACvB,iCAAiC;IACjC,mBAAmB;IACnB,uBAAuB;IACvB,wBAAwB;IACxB,uBAAuB;AAC3B;;AAEA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;;;;AAIA,mBAAmB;AACnB;IACI,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,8BAA8B;IAC9B,YAAY;IACZ,eAAe;AACnB;;;;AAIA;IACI,gCAAgC;IAChC,qBAAqB;IACrB,YAAY;IACZ,aAAa;IACb,YAAY;IACZ,uBAAuB;;AAE3B;;AAEA;IACI,0BAA0B;AAC9B;;AAEA;IACI,6BAA6B;IAC7B,YAAY;AAChB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,cAAc;AAClB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,YAAY;IACZ,sBAAsB;IACtB;AACJ;;AAEA;IACI,kBAAkB;AACtB;AACA,kBAAkB;AAClB;IACI;QACI,wBAAwB;IAC5B;;IAEA;QACI,aAAa;IACjB;;IAEA;QACI,8BAA8B;IAClC;;IAEA;QACI,aAAa;IACjB;;AAEJ;;AAEA,mBAAmB;AACnB;IACI;QACI,sBAAsB;IAC1B;;IAEA;QACI,aAAa;IACjB;;IAEA;QACI,6BAA6B;IACjC;;IAEA;QACI,aAAa;IACjB;AACJ;;AAEA,YAAY;AACZ;IACI;AACJ","sourcesContent":[":root {\n    --link-visited: #ca9c5e;\n    --default-font: Arial, sans-serif;\n    --icon-radius: 10px;\n    --large-icon-size: 40px;\n    --medium-icon-size: 30px;\n    --small-icon-size: 20px;\n}\n\n* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\n\n\n\n/* Element Styles */\nbody {\n    background-color: #000;\n}\n\nheader {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n    width: 100vw;\n    flex-wrap: wrap;\n}\n\n\n\nheader a, .side-nav a {\n    font-family: var(--default-font);\n    text-decoration: none;\n    color: white;\n    display: flex;\n    padding: 5px;\n    justify-content: center;\n\n}\n\na:hover, a:active {\n    color: var(--link-visited);\n}\n\nheader img {\n    width: var(--large-icon-size);\n    margin: 10px;\n}\n\n.social-links {\n    display: flex;\n}\n\nbody {\n    background-color: red;\n}\n\nheader ul {\n    display: none;\n    list-style: none;\n}\n\nheader button {\n    display: block;\n}\n\nli {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n.side-nav {\n    display: flex;\n    flex-direction: column;\n    width: 100vw;\n    background-color: #000;\n    align-items: center\n}\n\na {\n    text-align: center;\n}\n/* Tablet Styles */\n@media only screen and (min-width: 563px) and (max-width: 960px) {\n    body {\n        background-color: orange;\n    }\n\n    header .menu-button {\n        display: none;\n    }\n\n    header img {\n        width: var(--medium-icon-size);\n    }\n\n    header ul {\n        display: flex;\n    }\n\n}\n\n/* Desktop Styles */\n@media only screen and (min-width: 961px) {\n    body {\n        background-color: blue;\n    }\n\n    header .menu-button {\n        display: none;\n    }\n\n    header img {\n        width: var(--small-icon-size);\n    }\n\n    header ul {\n        display: flex;\n    }\n}\n\n/* Toggles */\n.invis {\n    display: none\n}"],"sourceRoot":""}]);
// Exports
...
sideNavButton.addEventListener('click', () => {
    ...
    console.log(_sidebar__WEBPACK_IMPORTED_MODULE_7__.sideBar)
})
